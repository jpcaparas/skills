Nano Banana 2 image generation prompt for the `markdown-new` README skill badge.
...
Subject: a cloud portal turning raw fragments into neatly stacked blank content blocks.
