Nano Banana 2 image generation prompt for the `skill-creator-advanced` README skill badge.
...
Subject: a skill forge crafting a reusable instruction cartridge from blank parts and test gems.
