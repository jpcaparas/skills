...
| `references/directional-controls.md` | A prepared game, simulation, or interactive 3D run requires directional verification; use it to implement the production-state adapter and run the digest-bound browser gate. |
