...
| --- | --- |
| `references/catalogue-authoring.md` | Adding templates; use it to preserve stable IDs, goal-only prompt style, and the silent shared prompt-crafting direction. |
