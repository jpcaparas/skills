Nano Banana 2 image generation prompt for the `oneshot-websites` README skill badge.
...
Subject: tiny blank world portals spawning different complete website landscapes.
