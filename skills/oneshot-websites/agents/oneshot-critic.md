...
5. If the result is not ready, identify the smallest coherent batch of material, co-fixable blockers. Prefer shared root causes and acceptance failures over serially revealing one gap at a time, but exclude minor polish, taste-equivalent differences, and an exhaustive wish list. If evidence contradicts a requested diagnosis, report the evidence and the more likely cause.
