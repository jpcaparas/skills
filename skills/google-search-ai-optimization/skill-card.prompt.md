Nano Banana 2 image generation prompt for the `google-search-ai-optimization` README skill badge.
...
Subject: a search tower sending clear signals to crawler fireflies and answer crystals.
