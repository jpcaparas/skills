Nano Banana 2 image generation prompt for the `make-my-code-flirtatious` README skill badge.
...
Subject: two elegant code-block spirits circling a warm glowing heart-shaped logic core, with blush-pink chemistry sparks and precise connector rails.
