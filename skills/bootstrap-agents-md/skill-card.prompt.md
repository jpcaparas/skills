Nano Banana 2 image generation prompt for the `bootstrap-agents-md` README skill badge.
...
Subject: a repository observatory distilling many project signal paths into one durable guidance beacon with a smaller companion beacon linked beside it.
