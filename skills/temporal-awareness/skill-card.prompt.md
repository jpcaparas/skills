Nano Banana 2 image generation prompt for the `temporal-awareness` README skill badge.
...
Subject: a numeral-free clock tower aligning blank date blocks and live verification beacons.
