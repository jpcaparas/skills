Nano Banana 2 image generation prompt for the `reading-notes` README skill badge.
...
Subject: a reading desk collecting bookmarks, highlight bars, and task gems around a glowing source.
