Nano Banana 2 image generation prompt for the `azure-devops-create-work-item` README skill badge.
...
Subject: a quest-token forge where a hammer stamps a blank glowing slab into a task gem.
