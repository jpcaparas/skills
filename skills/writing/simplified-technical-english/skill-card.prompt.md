Nano Banana 2 image generation prompt for the `simplified-technical-english` README skill badge.
...
Subject: a precision language workshop where tangled instruction paths pass through a calibration gate into short clear action rails, with terminology gems, a hazard shield, and separate procedure and description lanes.
