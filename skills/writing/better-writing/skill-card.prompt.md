Nano Banana 2 image generation prompt for the `better-writing` README skill badge.
...
Subject: a quill-shaped tool smoothing a jagged ribbon into a clean luminous ribbon.
