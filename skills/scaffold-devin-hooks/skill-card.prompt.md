Nano Banana 2 image generation prompt for the `scaffold-devin-hooks` README skill badge.
...
Subject: a Devin lifecycle hook switchboard with event levers, blocking gates, and reusable script cartridges.
