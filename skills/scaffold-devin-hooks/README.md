...
- generated `.devin/hooks/README.md` output so the target project has a readable event map
...
- `scripts/merge_hooks_file.sh` to merge generated hooks into `.devin/hooks.v1.json` without trampling unrelated hooks
