Nano Banana 2 image generation prompt for the `tarsier` README skill badge.
...
Subject: a tiny bicycle courier carrying an art packet through a pixel side-scroller lane.
