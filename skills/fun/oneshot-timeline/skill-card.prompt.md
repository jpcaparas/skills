Nano Banana 2 image generation prompt for the `oneshot-timeline` README skill badge.
...
Subject: a winding trail of evenly separated story beacons untangling a knot of pathways, with small framed silhouette gems alternating beside the trail and a warm lantern illuminating the next moment.
