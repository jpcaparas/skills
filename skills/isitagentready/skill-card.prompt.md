Nano Banana 2 image generation prompt for the `isitagentready` README skill badge.
...
Subject: a checkpoint scanner testing a website gate with robot-readable path beacons.
