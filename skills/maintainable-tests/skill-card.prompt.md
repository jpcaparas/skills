Nano Banana 2 image generation prompt for the `maintainable-tests` README skill badge.
...
Subject: a testing garden of clear scenario tiles, boundary markers, legacy anchors, and readable assertion gems.
