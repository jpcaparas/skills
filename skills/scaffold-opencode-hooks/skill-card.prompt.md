Nano Banana 2 image generation prompt for the `scaffold-opencode-hooks` README skill badge.
...
Subject: an OpenCode plugin switchboard with lifecycle levers connected to reusable script cartridges.
