Nano Banana 2 image generation prompt for the `repository-readme-writer` README skill badge.
...
Subject: a project book shrine assembled from setup tools, blank blocks, and guide rails.
