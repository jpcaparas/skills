Nano Banana 2 image generation prompt for the `maintainable-app` README skill badge.
...
Subject: a resilient app control room with queue rails, recovery beacons, heartbeat gems, observability signal towers, and shielded service paths.
