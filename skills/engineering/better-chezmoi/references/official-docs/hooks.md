...
Official source: https://www.chezmoi.io/reference/configuration-file/hooks/

Branch: automation

Site last modified: 2026-07-07

Article SHA-256: `d43535bfde6ca83ed3b503a26233296547d384a9a460077d0c1595429ca0b9a1`
...
A command contains a `command` or `script` and an optional array of strings `args`. `command`s are executed directly. `script`s are executed with configured interpreter for the script's extension, see the [section on interpreters](https://www.chezmoi.io/reference/configuration-file/interpreters/) .
