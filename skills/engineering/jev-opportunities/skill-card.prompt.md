Nano Banana 2 image generation prompt for the `jev-opportunities` README skill badge.
...
Subject: an experiment workbench beside an existing machine, where a small decision prism tests a swift shortcut rail and an evidence balance before a guarded path rejoins the original route, with saved energy gems nearby.
