# GitHub Copilot Harness Playbook

Internal component of the `scaffold-hooks` skill. This playbook owns the GitHub Copilot hook event contract, scaffolding scripts, and merge behavior for `.github/hooks/copilot-hooks.json`. Paths are relative to `harnesses/copilot/` unless noted.
