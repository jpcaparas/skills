Nano Banana 2 image generation prompt for the `scaffold-hooks` README skill badge.
...
Subject: a universal agent hook switchboard routing four harness cables into one shared script rail.
