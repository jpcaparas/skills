Nano Banana 2 image generation prompt for the `adhd-friendly` README skill badge.
...
Subject: a focused pathway where scattered task fragments converge through a calm priority gate into one bright next-step tile, with completed progress gems behind and optional paths parked nearby.
