#!/usr/bin/env python3
"""
validate.py - Validate the better-writing skill structure and conventions.
...
def validate_skill(skill_path: str) -> dict[str, object]:
    ...
    for rel_path in ["scripts/probe_better_writing.py", "scripts/validate.py", "scripts/test_skill.py"]:
