Nano Banana 2 image generation prompt for the `secure-ai-agent-coding` README skill badge.
...
Subject: a guarded agent workbench behind shields, permission gates, and safe tool lanes.
