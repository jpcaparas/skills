Nano Banana 2 image generation prompt for the `ripgrep` README skill badge.
...
Subject: a magnifying beam racing through file shelves and lighting up matching pixels.
