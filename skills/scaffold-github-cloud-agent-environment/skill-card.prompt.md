Nano Banana 2 image generation prompt for the `scaffold-github-cloud-agent-environment` README skill badge.
...
Subject: a cloud runner factory wiring setup pipes into a safe agent workspace.
