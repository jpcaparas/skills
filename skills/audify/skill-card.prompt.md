Nano Banana 2 image generation prompt for the `audify` README skill badge.
...
Subject: headphones catching flowing sound ribbons, waveform crystals, and a small studio mixer made of blank blocks.
