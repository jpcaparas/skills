Nano Banana 2 image generation prompt for the `scaffold-codex-hooks` README skill badge.
...
Subject: a Codex hook switchboard with event levers connected to reusable script cartridges.
