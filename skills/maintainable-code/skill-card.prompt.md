Nano Banana 2 image generation prompt for the `maintainable-code` README skill badge.
...
Subject: a code workshop arranging clear modular blocks, typed connector rails, test gems, and simple responsibility lanes.
