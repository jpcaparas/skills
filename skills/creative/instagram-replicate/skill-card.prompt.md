Nano Banana 2 image generation prompt for the `instagram-replicate` README skill badge.
...
Subject: a camera portal rebuilding a scene into film reels, snapshot tiles, and local asset crates.
