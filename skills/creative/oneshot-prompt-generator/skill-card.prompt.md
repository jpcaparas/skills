Nano Banana 2 image generation prompt for the `oneshot-prompt-generator` README skill badge.
...
Subject: a precision prism scanner combining visual, motion, structure, and interaction reference gems into one bright handoff beam that enters a fresh empty world portal.
