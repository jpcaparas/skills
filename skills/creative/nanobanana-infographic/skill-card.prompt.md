Nano Banana 2 image generation prompt for the `nanobanana-infographic` README skill badge.
...
Subject: abstract chart-like towers, simple icon gems, and one bright banana-shaped spark.
