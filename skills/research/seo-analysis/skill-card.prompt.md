Nano Banana 2 image generation prompt for the `seo-analysis` README skill badge.
...
Subject: a crawl-path garden where sitemap nodes glow under search spotlights.
