Nano Banana 2 image generation prompt for the `youtube-transcript-dossier` README skill badge.
...
Subject: a play portal unfolding a ribbon of caption gems into a tidy dossier with bookmark rails and topic tiles.
