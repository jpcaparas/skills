Nano Banana 2 image generation prompt for the `synthetic-search` README skill badge.
...
Subject: a zero-retention radar scanning the web through clean privacy lanes.
