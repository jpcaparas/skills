Nano Banana 2 image generation prompt for the `lean-text-scaffolding` README skill badge.
...
Subject: a compact layout workbench trimming bulky placeholder ribbons and blank tag blocks into a clean sparse interface panel.
