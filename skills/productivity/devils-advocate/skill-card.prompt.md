Nano Banana 2 image generation prompt for the `devils-advocate` README skill badge.
...
Subject: two opposing debate champions facing each other across a glowing balance arena, with one mirrored argument shield, pressure-test sparks, and a central evidence gem.
