Nano Banana 2 image generation prompt for the `travel-plan-spreadsheet-generator` README skill badge.
...
Subject: a travel desk arranging route tiles, luggage, blank tickets, and grid gems.
