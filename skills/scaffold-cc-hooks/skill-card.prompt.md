Nano Banana 2 image generation prompt for the `scaffold-cc-hooks` README skill badge.
...
Subject: a Claude hook switchboard with event levers connected to reusable script cartridges.
