Nano Banana 2 image generation prompt for the `mockable-code` README skill badge.
...
Subject: a testing workbench with interchangeable dependency cartridges, stub blocks, fake service gems, and clean adapter rails.
