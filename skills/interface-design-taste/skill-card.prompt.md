Nano Banana 2 image generation prompt for the `interface-design-taste` README skill badge.
...
Subject: a refined workbench arranging blank layout panels, color swatches, and spacing rails.
