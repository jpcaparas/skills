Nano Banana 2 image generation prompt for the `codex-subagents` README skill badge.
...
Subject: a command center splitting one bright task beam into several parallel agent lanes, each returning small summary gems to a central console.
