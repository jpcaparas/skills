Nano Banana 2 image generation prompt for the `zoom-out` README skill badge.
...
Subject: a camera lifting above a code city to reveal modules, routes, and call paths.
