Nano Banana 2 image generation prompt for the `product-question` README skill badge.
...
Subject: a side-scrolling path of user-flow tiles and glowing inquiry gems leading toward a code city skyline, with simple unlabeled connectors and no screens or papers.
