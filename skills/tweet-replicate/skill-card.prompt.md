Nano Banana 2 image generation prompt for the `tweet-replicate` README skill badge.
...
Subject: a social portal frame being rebuilt into a local video reel, snapshot tile, and asset crate.
