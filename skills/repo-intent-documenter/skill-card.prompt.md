Nano Banana 2 image generation prompt for the `repo-intent-documenter` README skill badge.
...
Subject: a compass room connecting repository clue gems into a clear route line.
