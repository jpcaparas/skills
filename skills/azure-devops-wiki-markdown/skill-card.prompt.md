Nano Banana 2 image generation prompt for the `azure-devops-wiki-markdown` README skill badge.
...
Subject: a knowledge temple linking clean geometric blocks through glowing connector paths.
