Nano Banana 2 image generation prompt for the `client-report-from-commits` README skill badge.
...
Subject: commit stones merging into a polished crystal stack for a stakeholder path.
