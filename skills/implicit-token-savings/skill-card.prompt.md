Nano Banana 2 image generation prompt for the `implicit-token-savings` README skill badge.
...
Subject: a compact token backpack moving through a narrow efficient corridor.
