Nano Banana 2 image generation prompt for the `scaffold-github-copilot-hooks` README skill badge.
...
Subject: a GitHub Copilot hook control room wiring repository hooks to shared script adapters.
