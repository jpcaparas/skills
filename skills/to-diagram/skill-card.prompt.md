Nano Banana 2 image generation prompt for the `to-diagram` README skill badge.
...
Subject: a tangled maze of process rails entering a clarity prism and emerging as one clean branching flow with phase gates and an image crystal.
