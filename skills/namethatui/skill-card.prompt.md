Nano Banana 2 image generation prompt for the `namethatui` README skill badge.
...
Subject: a field-guide scanner comparing an unknown floating interface shape with clear button, menu, panel, and dialog silhouette gems connected to trusted reference beacons.
