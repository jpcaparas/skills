...
# script.sh
#
# Canonical event script for PostCompaction.
#
# What this event is for:
#   Runs after context compaction completes successfully.
#
# Blocking guidance:
#   Prefer non-blocking logging or context repair after compaction.
#
...
: "${AGENT_HOOK_EVENT:=PostCompaction}"
...
handle_event() {
    ...
    #
    # Devin-specific helpers come from hooks/lib/devin.sh.
    #
    # Keep stdout empty unless this hook intentionally sends JSON back to Devin.
