...
# script.sh
#
# Canonical event script for MessageDisplay.
#
# What this event is for:
#   Runs while assistant message text is displayed and can transform display content.
#
# Recommended starting style:
#   Keep sync and fast; failures should fall back to the original displayed text.
#
...
: "${AGENT_HOOK_EVENT:=MessageDisplay}"
