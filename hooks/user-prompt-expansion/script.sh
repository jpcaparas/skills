...
# script.sh
#
# Canonical event script for UserPromptExpansion.
#
# What this event is for:
#   Runs when a user-typed slash command or MCP prompt expands before reaching Claude.
#
# Recommended starting style:
#   Keep sync when you need to block a command expansion or inject expansion-specific context.
#
...
: "${AGENT_HOOK_EVENT:=UserPromptExpansion}"
