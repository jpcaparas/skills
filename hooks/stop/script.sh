...
# script.sh
#
# Canonical event script for Stop.
#
# What this event is for:
#   Runs when Claude finishes responding.
#
# Recommended starting style:
#   Keep sync for end-of-turn quality gates. Use async only for passive side effects like notifications.
#
