...
# script.sh
#
# Canonical event script for SessionStart.
#
# What this event is for:
#   Runs when a session begins, resumes, clears, or starts after compaction.
#
# Recommended starting style:
#   Use sync when you need context, environment, or bootstrap work before Claude continues.
#
