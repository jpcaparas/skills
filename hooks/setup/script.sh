...
# script.sh
#
# Canonical event script for Setup.
#
# What this event is for:
#   Runs only for explicit initialization or maintenance invocations such as --init-only, or --init/--maintenance in print mode.
#
# Recommended starting style:
#   Keep sync for explicit setup work, but do not rely on this for normal session startup.
#
