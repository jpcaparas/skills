...
# script.sh
#
# Canonical event script for PermissionDenied.
#
# What this event is for:
#   Runs when a tool call is denied by the auto mode classifier.
#
# Recommended starting style:
#   Keep sync when you want to suggest a retry or a deterministic recovery path.
#
...
: "${AGENT_HOOK_EVENT:=PermissionDenied}"
