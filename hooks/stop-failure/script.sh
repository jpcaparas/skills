...
# script.sh
#
# Canonical event script for StopFailure.
#
# What this event is for:
#   Runs when a turn ends because of an API error.
#
# Recommended starting style:
#   Often async because the main value is audit or alerting, and output is ignored.
#
