...
# script.sh
#
# Canonical event script for WorktreeRemove.
#
# What this event is for:
#   Runs when a worktree is being removed.
#
# Recommended starting style:
#   Often async for cleanup, unless the cleanup must complete before the worktree is considered gone.
#
...
: "${AGENT_HOOK_EVENT:=WorktreeRemove}"
