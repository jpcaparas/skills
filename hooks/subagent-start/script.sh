...
# script.sh
#
# Canonical event script for SubagentStart.
#
# What this event is for:
#   Runs when a subagent is spawned.
#
# Recommended starting style:
#   Often async for logging or external coordination. Keep sync only when startup context must finish first.
#
...
: "${AGENT_HOOK_EVENT:=SubagentStart}"
